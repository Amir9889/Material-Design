...
public class DetailSugFoodAdapter extends RecyclerView.Adapter<DetailSugFoodAdapter.MyViewHolder> {

    Context context;
    List<Food> data;

    public DetailSugFoodAdapter(Context context, List<Food> data) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.item_sug_detail_food, parent, false);
